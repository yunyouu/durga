...
request.get("https://api.github.com/repos/shufflewzc/faker2").then((res) => {
  ...
  if (dayjs.utc(updated_at).diff(dayjs.utc(), "m") > -5) {
    ...
    exec(
      'docker exec -it qinglong ql repo https://ghproxy.com/https://github.com/shufflewzc/faker2.git "jd_|jx_|gua_|jddj_|getJDCookie" "activity|backUp" "^jd[^_]|USER|function|utils|ZooFaker_Necklace.js|JDJRValidator_Pure|sign_graphics_validate|ql"',
